...
const faqs=[
 ...
 ["¿Austral Web puede renovar una página existente?","Sí. Revisamos el sitio actual y proponemos mejoras visuales, de estructura, experiencia y rendimiento."],
